...
const FText FTextMenu = LOCTEXT("菜单", "菜单");//菜单
...
//#define TESTT SlAiIntemational::Register(LOCTEXT("Menu", "Menu"));//游戏设置

////#define TESTT SlAiIntemational::Register(LOCTEXT("GameOption", "GameOption"));//游戏设置
